...
def planeline_intersection(a, b, p, n):
    ...
    :rtype: ndarray
    """
    # a, b: 3D points defined a line
    # p, n: 3D point and normal vector defined a plane
...
def projection(n, p, pp, x):
    # n - normal vector define plane (outer vector of surface)
    # p - point define plane
    # pp - projection point parameter (define projection point)
